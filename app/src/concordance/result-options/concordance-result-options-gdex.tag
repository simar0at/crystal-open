<concordance-result-options-gdex class="concordance-result-options-gdex">
    ...
    <script>
        ...
        updateAttributes(){
            this.gdexconfs = AppStore.get("gdexConfsLoaded") ? AppStore.get("gdexConfs") : [{'label': _("cc.gdexDefault"), 'value': '__default__'}]
        }
...
</concordance-result-options-gdex>
