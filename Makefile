...
install: bundle.js
	...
	cp viz.js vendors-viz.js $(DESTDIR)/var/www/crystal/ || :
	cp -r bundle.js vendors-main.js app/{index.html,config.js,favicon.ico,images,libs,locale,styles,texts} $(DESTDIR)/var/www/crystal/
